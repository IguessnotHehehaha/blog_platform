...
import com.learning.blog.security.BlogUserDetailsService;
import com.learning.blog.security.JwtAuthenticationFilter;
...
public class SecurityConfig {
    ...
    public UserDetailsService userDetailsService(UserRepository userRepository) {
        ...
        userRepository.findByEmail(email).orElseGet(() ->{
            User newUser = User.builder().name("Test user").email(email)
